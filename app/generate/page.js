...
export default function Generate() {
    ...
    const saveFlashcards = async () =>{
        ...
        if (docSnap.exists()) {
            ...
            if (collections.find((f) => f.name === name)){
                ...
                batch.set(userDocRef, {flashcards: collections}, {mersge: true})
            }
        } else {
    ...
    return <Container maxWidth='md'>
        <Box sx={{mt:4, mb:6, display:'flex', flexDirections:'column', alignItems:'center'}}>
            <Typography>Generate Flashcards</Typography>
                                        ...
                                        <Box 
                                            sx={{
                                                ...
                                                '& > div': {
                                                    ...
                                                    width:'100%',
                                                    height:'200px',
                                                    boxShadow:'0 4px 4px 0 rgna(0,0,0,0.2)',
        ...
        <Dialog open={open} onClose={handleClose}>
            ...
            <DialogContent>
                <DialogContentText>
                    PPlease enter name for flashcards collection
                </DialogContentText>
